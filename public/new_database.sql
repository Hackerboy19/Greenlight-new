...
-- ------------------------------------------------------------------------------
-- 4. TABLE: articles (Migrated from ci_blog)
-- ------------------------------------------------------------------------------
...
(
  ...
  '<h1><strong>Introduction to India’s Diverse Travel Destinations</strong></h1><p>India is a land of incredible diversity, offering everything from majestic mountains and serene beaches to historical monuments and vibrant cities. Exploring the top tourist places in India allows travelers to experience rich culture, heritage, and breathtaking landscapes all in one journey.</p><h3><strong>1. Agra – The City of Love</strong></h3><p>Home to the iconic Taj Mahal, Agra is one of the most visited tourist destinations in India. Along with the Taj Mahal, Agra Fort and Fatehpur Sikri add historical charm to the city.</p><h3><strong>2. Jaipur – The Pink City</strong></h3><p>Jaipur is famous for its royal heritage, grand palaces, and vibrant culture. Attractions like Amer Fort, City Palace, and Hawa Mahal make it a must-visit destination for those who love history and architecture.</p><h3><strong>3. Kashmir – Heaven on Earth</strong></h3><p>Known for its breathtaking beauty, Kashmir offers stunning landscapes, snow-capped mountains, and serene lakes like Dal Lake. It is a perfect destination for nature lovers and honeymooners.</p><h3><strong>4. Goa – The Beach Paradise</strong></h3><p>Goa is famous for its beautiful beaches, nightlife, and Portuguese heritage. From relaxing on sandy shores to enjoying water sports, Goa is ideal for both relaxation and adventure.</p><h3><strong>5. Kerala – God’s Own Country</strong></h3><p>Kerala is known for its backwaters, lush greenery, and tranquil environment. Houseboat cruises in Alleppey and the scenic beauty of Munnar make Kerala a unique travel experience.</p><h3><strong>6. Leh-Ladakh – Adventure Hub</strong></h3><p>Leh-Ladakh is a dream destination for adventure seekers with rugged mountains and high-altitude passes.</p><h3><strong>7. Varanasi – Spiritual Capital of India</strong></h3><p>Varanasi is one of the oldest cities in the world, known for Ganga Aarti and sacred ghats.</p><h3><strong>8. Delhi – The Heart of India</strong></h3><p>Delhi blends modern life with historical charm from India Gate to Red Fort.</p><h3><strong>9. Andaman & Nicobar Islands – Tropical Escape</strong></h3><p>White sandy beaches and turquoise waters make Andaman ideal for snorkeling and diving.</p><h3><strong>10. Darjeeling – The Queen of Hills</strong></h3><p>Darjeeling is known for its rolling tea gardens, cool climate, and views of Kanchenjunga.</p>',
...
(
  ...
  '<h1><strong>Introduction to Radiant Skin and Skincare Importance</strong></h1><p>Healthy, radiant skin is a reflection of proper care, balanced lifestyle, and the right skin care products. Choosing the best skincare brands plays a crucial role in maintaining glowing and younger skin.</p><h3><strong>What Defines the Best Skin Care Brand?</strong></h3><p>The best skincare brands are known for their quality ingredients, dermatologically tested formulation, and validated results. A reliable brand focuses on safe, effective, and skin-friendly components that nourish and protect the skin.</p><h3><strong>Top Features of a Radiant Skin Care Brand</strong></h3><p>A good skin care brand offers a complete range including cleansers, moisturizers, serums, and sunscreens infused with ingredients like aloe vera, vitamin C, and hyaluronic acid.</p>',
...
(
  ...
  '<p>Social media is continuously developing, and the leading top Instagram influencers in India are on the front lines of forming online trends. Personalities across fashion, fitness, travel, and lifestyle inspire millions of engaged followers every day.</p><h1><strong>Emerging Talents of Instagram in India</strong></h1><p>From fashion innovators like Komal Pandey to fitness athletes and travel creators, Indian creators are driving global collaborations and changing digital commerce.</p>',
...
(
  ...
  '<p>India has turned into a global innovation center and business hub. The emergence of top entrepreneurs in India has revolutionized industries, generated employment, and catalyzed technological adoption across the globe.</p><h1><strong>Pillars of Indian Enterprise</strong></h1><p>From industrial titans like Mukesh Ambani and Ratan Tata to modern startup innovators like Vijay Shekhar Sharma and Falguni Nayar, Indian entrepreneurs exemplify resilience and market vision.</p>',
...
(
  ...
  '<p>In the last decade, successful startups in India have revolutionized entire markets. Digital public infrastructure, venture capital, and deep technical talent have positioned India as the third-largest startup ecosystem worldwide.</p><h2><strong>Fast-Scaling Unicorn Companies</strong></h2><p>Companies like Razorpay, Swiggy, and Zepto have scaled rapidly, demonstrating execution capability and solving everyday consumer challenges at unprecedented scale.</p>',
...
(
  ...
  '<p>The global entertainment ecosystem has transformed with digital streaming, virtual reality, and international co-productions. Leading entertainment conglomerates are blending artificial intelligence with creative storytelling to capture worldwide audiences.</p>',
...
(
  ...
  '<p>Indian hospitality is revered worldwide for its warmth and grandeur. Converted royal fortresses and state-of-the-art modern high-rises provide bespoke experiences, Michelin-standard dining, and tranquil luxury in Rajasthan, Mumbai, Delhi, and Goa.</p>',
...
(
  ...
  '<p>India is a culinary paradise combining ancient royal recipes with modern molecular gastronomy. Celebrated spots like Indian Accent and Wasabi by Morimoto showcase the apex of flavor, service, and ambiance.</p>',
...
(
  ...
  '<p>Planning a memorable family holiday requires comfort, safety, and enriching activities for every generation. Discover the top scenic locations from the snowy peaks of Manali to the tropical beaches of Andaman and royal palaces of Jaipur.</p>',
...
-- Old Database (jaipurwe_fsianewss):
--   - 17 legacy ci_* tables (CodeIgniter 3 monolithic structure)
--   - Mixed latin1_swedish_ci / utf8mb4 collation with inconsistent encodings
--   - No foreign key integrity, missing indexes on slugs and query joins
-- Modernized Database (greenlight_db):
--   - 10 clean, normalized, modern tables with full relational integrity
--   - utf8mb4_unicode_ci collation across all tables
--   - Automatic timestamps with ON UPDATE CURRENT_TIMESTAMP
--   - B-tree and FULLTEXT indexes on search, slug, and status
--   - Native support for Wikipedia Infobox Factsheets and Google FAQ Schema
-- ==============================================================================
